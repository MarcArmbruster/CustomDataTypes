namespace System.CustomDataTypes
{
    ...
    /// <summary>
    /// MilliJoule: Implementation of IConvertible
    /// </summary>
    public readonly partial struct MilliJoule : IConvertible
    {
        public static implicit operator MilliJoule(decimal exactValue) => new MilliJoule(exactValue);
        public static explicit operator decimal(MilliJoule MilliJoule) => MilliJoule.Value;
