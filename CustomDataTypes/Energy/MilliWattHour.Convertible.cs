namespace System.CustomDataTypes
{
    ...
    /// <summary>
    /// MilliWattHour: Implementation of IConvertible
    /// </summary>
    public readonly partial struct MilliWattHour : IConvertible
    {
        public static implicit operator MilliWattHour(decimal exactValue) => new MilliWattHour(exactValue);
        public static explicit operator decimal(MilliWattHour MilliWattHour) => MilliWattHour.Value;
