namespace System.CustomDataTypes
{
    ...
    /// <summary>
    /// KilloWattHour: Implementation of IConvertible
    /// </summary>
    public readonly partial struct KilloWattHour : IConvertible
    {
        public static implicit operator KilloWattHour(decimal exactValue) => new KilloWattHour(exactValue);
        public static explicit operator decimal(KilloWattHour KilloWattHour) => KilloWattHour.Value;
